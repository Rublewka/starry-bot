...
client = commands.Bot(command_prefix = settings['PREFIX'], intents=discord.Intents.all()) # Создаем переменную client используемую для всех наших взаимодействий с ботом
